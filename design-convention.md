...
如果在系统中，需要通过环境变量配置指向其他系统的超链接，除了遵循[通用的环境变量命名规则](#环境变量)外，还需要遵循以下的规则：
- 目标系统的代号放在第二位
- 目标系统的子平台代号放在第三位
- 目标系统的资源名称放在第四位
- 单词 LINK 放在第五位
...
如果在系统中，需要配置分页相关的环境变量，除了遵循[通用的环境变量命名规则](#环境变量)外，还需要遵循以下的规则：
- 子平台代号放在第二位
- 资源名称放在第三位
- 单词 PER_PAGE 放在第四位
...
如果在本系统中，需要通过环境变量配置指向其他系统的超链接，除了遵循[通用的环境变量命名规则](#环境变量)外，还需要遵循以下的规则：
- 所有单词大写
- 单词之间用下划线连接
- 本系统的代号放在第一位
- 目标系统的代号放在第二位
